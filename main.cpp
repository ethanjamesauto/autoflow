...
int main() {
    ...
    mult.learningRate = Tensor(learning_rate, mult.learningRate.shape);
    add.learningRate = Tensor(learning_rate, add.learningRate.shape);
    mult2.learningRate = Tensor(learning_rate, mult2.learningRate.shape);
    add2.learningRate = Tensor(learning_rate, add2.learningRate.shape);
